...
export default function FinancialStats({ periodIdName, navigation }) {
  ...
  return (
    <Card>
      <StatsCardHeader title={"Financial Stats"} />
        ...
        <View>
          <View style={{}}>
            {[
              ...
              {
                name: "Total Sold",
                value: `${getTotal("totalSold")} ($${getTotal(
                  "totalSoldAmount"
                )})`,
                // onClick: () => {
                // },
              ...
              },
              {
                ...
                value: `${getTotal("totalPurchased")} ($${getTotal(
